...
class GasEstimationApp(QWidget):
    ...
    def create_gas_selection_screen(self):
        ...
        self.next_button.clicked.connect(self.create_input_screen)
    ...
    def create_input_screen(self):
        ...
        # Clear previous UI elements and set up the scroll area
        self.clear_layout(self.main_layout)
        ...
        # Add molar fraction inputs for selected components
        self.molar_fraction_inputs = {}
        for component in self.selected_components:
            molar_input = QLineEdit()
            input_layout.addRow(f"{component} Molar Fraction:", molar_input)
